...
import { ChevronDown, ChevronDownIcon, ChevronUp, Loader2, RotateCw, Search } from "lucide-react";
    ...
    <div className="w-ful bg-white rounded-md shadow flex flex-col items-center">
      <div className="h-14 w-full border-b border-zinc-200 flex items-center justify-between px-2">
        <div className="flex items-center gap-1.5">
          ...
          <div className="flex items-center gap-1.5">
            <Input {...register("page")} 
              className={classNames("w-12 h-8", errors.page && "focus-visible:ring-red-500")} 
              onKeyDown={(e) => {
                if(e.key === "Enter") {
