...
export default function Home() {
  return (
    <>
      <MaxWidthWrapper
        className="mb-12 mt-28 sm:mt-40 
      ...
      >
        ...
        <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
          Chat-PDF allows you to have conversations with any PDF document.
          Simply upload your file and start asking questions rigth away.
        </p>
      ...
      <div className="mx-auto mb-32 mt-32 max-w-5xl sm:mt-56">
        <div className="mb-12 px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-4 text-lg text-gray-600">
              Chatting to your PDF files has never been that easier.
            </p>
          </div>
        </div>
        ...
        <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 pl-4 md:border-l-0 md:border-t-2 mn:pb-0 md:pl-0 md:pt-4">
              <span className="text-sm font-medium text-orange-600"> Step 1</span>
              <span className="text-xl font-semibold">Sign up for an free account</span>
          ...
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 pl-4 md:border-l-0 md:border-t-2 mn:pb-0 md:pl-0 md:pt-4">
              ...
              <span className="mt-2 text-zinc-700">It&apos;s that simple Try out today - it really takes less than a minut.</span>
            </div>
          </li>
        </ol>
